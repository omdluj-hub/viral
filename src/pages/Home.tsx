        ...
        <div className="container footer-inner">
          ...
          <div className="footer-details">
            <div className="footer-links">
              <strong style={{ display: 'block', marginBottom: '5px', color: '#fff' }}>교통사고/입원실</strong>
            ...
            <div className="footer-links" style={{ marginTop: '15px' }}>
              <strong style={{ display: 'block', marginBottom: '5px', color: '#fff' }}>다이어트 프로그램</strong>
              <a href="/gumi-diet.html">구미다이어트</a>
              <a href="/gumi-diet-herbal.html">구미 다이어트 한약</a>
              <a href="/gumi-oriental-diet.html">구미 한방 다이어트</a>
